...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([TestNotificationButton(coordinator) for coordinator in coordinators.values()])


class TestNotificationButton(ButtonEntity):
    """Send a test notification using the configured notification target."""
